...
export default function RequestListingPage() {
  ...
  const handleDeleteRow = (id: string) => {
    const deleteRow = tableData.filter((row) => row.requestID.toString() !== id);
    setSelected([]);
                  ...
                  {_mockData
                    ...
                    .map((row) => (
                      <RequestRow
                        ...
                        onSelectRow={() => onSelectRow(row.requestID.toString())}
                        onEditRow={() => handleEditRow(row.requestID.toString())}
                        onDeleteRow={() => handleDeleteRow(row.requestID.toString())}
                      />
                    ))}

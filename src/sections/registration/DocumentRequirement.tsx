    ...
    <Stack component={MotionViewport} spacing={5}>
      ...
      <m.div variants={varFade().inUp}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          <Typography variant="body2">- Thẻ căn cước công dân/mã số định danh cá nhân;</Typography>
          <Typography variant="body2">- Thẻ Bảo hiểm Y tế;</Typography>
          <Typography variant="body2">- Giấy tờ minh chứng sinh viên;</Typography>
        </Box>
